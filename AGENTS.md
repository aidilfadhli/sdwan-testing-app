...
2. **Non-Destructive Edits**: Do not mutate or refactor working legacy functions in existing files.
3. **Regression Safety**: Test existing paths to ensure zero regression before declaring tasks complete.
